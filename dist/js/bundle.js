...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _models_Search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/Search */ \"./src/js/models/Search.js\");\n/* harmony import */ var _models_movie__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/movie */ \"./src/js/models/movie.js\");\n/* harmony import */ var _models_likes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/likes */ \"./src/js/models/likes.js\");\n/* harmony import */ var _views_base__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/base */ \"./src/js/views/base.js\");\n\r\n\r\n\r\n\r\n\r\n// /** Global state of the app\r\n//  * \r\n//  */\r\n\r\nconst state = {};\r\n// search for a movie\r\nconst controlSearch = async() => {\r\n    // get value\r\n    const query = document.querySelector('.search__field').value;\r\n    if(query){\r\n        // new search\r\n        state.search = new _models_Search__WEBPACK_IMPORTED_MODULE_0__[\"default\"](query)\r\n        // clear old list if exists\r\n        Object(_views_base__WEBPACK_IMPORTED_MODULE_3__[\"clear\"])();\r\n        // add loader\r\n        Object(_views_base__WEBPACK_IMPORTED_MODULE_3__[\"renderLoader\"])(_views_base__WEBPACK_IMPORTED_MODULE_3__[\"elements\"].searchRes);\r\n        // add results\r\n        await state.search.getResults();\r\n        // remove loader\r\n        Object(_views_base__WEBPACK_IMPORTED_MODULE_3__[\"clearLoader\"])();\r\n        \r\n\r\n    }\r\n\r\n}\r\n// view a movie\r\nconst controlMovie = async() => {\r\n    // get the id\r\n    const id = window.location.hash.replace('#','');\r\n    if(id){ \r\n        // add new movie\r\n        state.movie = new _models_movie__WEBPACK_IMPORTED_MODULE_1__[\"default\"];\r\n        // highlight selected movie\r\n        if(state.search) Object(_views_base__WEBPACK_IMPORTED_MODULE_3__[\"highlightSelected\"])(id);\r\n        // clear old movie (if exists)\r\n        _views_base__WEBPACK_IMPORTED_MODULE_3__[\"elements\"].recipe.innerHTML = '';\r\n        // add loader\r\n        Object(_views_base__WEBPACK_IMPORTED_MODULE_3__[\"renderLoader\"])(_views_base__WEBPACK_IMPORTED_MODULE_3__[\"elements\"].recipe);\r\n        //new movie\r\n        state.movie = new _models_movie__WEBPACK_IMPORTED_MODULE_1__[\"default\"](id);\r\n        await state.movie.getMovie(state.likes.isLiked(id));\r\n        // remove loader\r\n        Object(_views_base__WEBPACK_IMPORTED_MODULE_3__[\"clearLoader\"])();\r\n        \r\n        \r\n    }\r\n}\r\n// like a movie\r\nconst controlLikes = () => {\r\n    // if no like add one\r\n    if(!state.likes) state.likes = new _models_likes__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\r\n    const currId = state.movie.id;\r\n    if(!state.likes.isLiked(currId)) {\r\n        const newLike = state.likes.addLike(\r\n            currId,\r\n            state.movie.Title,\r\n            state.movie.year,\r\n            state.movie.poster\r\n        );\r\n        // add to liked\r\n        Object(_views_base__WEBPACK_IMPORTED_MODULE_3__[\"toggleLikedBtn\"])(true);\r\n        Object(_views_base__WEBPACK_IMPORTED_MODULE_3__[\"renederLikes\"])(newLike);\r\n    } else {\r\n        state.likes.deleteLike(currId);\r\n        Object(_views_base__WEBPACK_IMPORTED_MODULE_3__[\"toggleLikedBtn\"])(false)\r\n        Object(_views_base__WEBPACK_IMPORTED_MODULE_3__[\"deleteLikes\"])(currId)\r\n    }\r\n    Object(_views_base__WEBPACK_IMPORTED_MODULE_3__[\"toogleLikeMenu\"])(state.likes.getNumLikes())\r\n    \r\n    \r\n\r\n}\r\n // new movie when  hash change and load the page\r\nwindow.addEventListener('hashchange', controlMovie);\r\nwindow.addEventListener('load',controlMovie)\r\n\r\n\r\n// search\r\n_views_base__WEBPACK_IMPORTED_MODULE_3__[\"elements\"].searchform.addEventListener('submit', e => {\r\n    e.preventDefault();\r\n    controlSearch();\r\n})\r\n// add like\r\n_views_base__WEBPACK_IMPORTED_MODULE_3__[\"elements\"].recipe.addEventListener('click' , e => {\r\n    if(e.target.matches('.recipe__love, .recipe__love *')){\r\n        controlLikes();\r\n    }\r\n})\r\n\r\nstate.likes = new _models_likes__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\r\n\r\n\r\n \r\n\n\n//# sourceURL=webpack:///./src/js/index.js?");
